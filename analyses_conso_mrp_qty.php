...
/**
 *    \file       fixmargin/analyses_conso_mrp_qty.php
 *    \ingroup    fixmargin
...
llxHeader("", $langs->trans("Analyse_Conso_qty"));
...
print load_fiche_titre($langs->trans("Analyse_Conso_qty")." ".$textprevyear." ".$langs->trans("Year")." ".$year_start." ".$textnextyear . " ".$otherTypeReport, '', 'title_accountancy');

print_barre_liste($langs->trans("Analyse_Conso_qty"). " ". $langs->trans('TypeReportMRP_'.$type_report), '', '', '', '', '', '', -1, '', '', 0, '', '', 0, 1, 1);
